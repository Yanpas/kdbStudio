...
public class KTest {
    ...
    public void testLongToString() throws Exception {
        check(new K.KLong(-123456789), "-123456789", "-123456789j");
        check(new K.KLong(-Long.MAX_VALUE), "-0W", "-0Wj");
        check(new K.KLong(Long. MAX_VALUE), "0W", "0Wj");
        check(new K.KLong(Long.MIN_VALUE), "0N", "0Nj");

        check(vector(K.KLongVector.class, -10, 10, 3), "-10 10 3", "-10 10 3j");
        check(vector(K.KLongVector.class), "`long$()", "`long$()");
        check(vector(K.KLongVector.class, 0), "enlist 0", "enlist 0j");
        check(vector(K.KLongVector.class, 5, Long.MIN_VALUE, Long.MAX_VALUE, -Long.MAX_VALUE), "5 0N 0W -0W", "5 0N 0W -0Wj");
    }
    ...
    public void testDoubleToString() throws Exception {
        check(new K.KDouble(-1.23), "-1.23", "-1.23");
        check(new K.KDouble(3), "3", "3f");
        check(new K.KDouble(0), "0", "0f");
        check(new K.KDouble(Double.POSITIVE_INFINITY ), "0w", "0w");
        check(new K.KDouble(Double.NEGATIVE_INFINITY), "-0w", "-0w");
        check(new K.KDouble(Double.NaN), "0n", "0n");

        check(vector(K.KDoubleVector.class, (double)-10, (double)10, (double)3), "-10 10 3f", "-10 10 3f");
        check(vector(K.KDoubleVector.class, (double)-10, 10.1, (double)3), "-10 10.1 3", "-10 10.1 3");
        check(vector(K.KDoubleVector.class), "`float$()", "`float$()");
        check(vector(K.KDoubleVector.class, (double)0), "enlist 0f", "enlist 0f");
        check(vector(K.KDoubleVector.class, (double)5, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, Double.NaN), "5 -0w 0w 0n", "5 -0w 0w 0n");
    }

    @Test
    public void testFloatToString() throws Exception {
        check(new K.KFloat(-1.23f), "-1.23", "-1.23");
        check(new K.KFloat(3), "3", "3e");
        check(new K.KFloat(0), "0", "0e");
        check(new K.KFloat(Float.POSITIVE_INFINITY ), "0we", "0we");
        check(new K.KFloat(Float.NEGATIVE_INFINITY), "-0we", "-0we");
        check(new K.KFloat(Float.NaN), "0ne", "0ne");

        check(vector(K.KFloatVector.class, -10f, 10f, 3f), "-10 10 3e", "-10 10 3e");
        check(vector(K.KFloatVector.class, -10f, 10.1f, 3f), "-10 10.1000004 3", "-10 10.1000004 3");
        check(vector(K.KFloatVector.class), "`real$()", "`real$()");
        check(vector(K.KFloatVector.class, 0f), "enlist 0e", "enlist 0e");
        check(vector(K.KFloatVector.class, 5f, Float.NEGATIVE_INFINITY, Float.POSITIVE_INFINITY, Float.NaN), "5 -0W 0W 0N", "5 -0W 0W 0N");
    }
    ...
    public void testSymbolToString() throws Exception {
        ...
        check(vector(K.KSymbolVector.class), "0#`", "0#`");
    ...
    public void testDateToString() throws Exception {
        ...
        check(vector(K.KDateVector.class, 5, Integer.MIN_VALUE, Integer.MAX_VALUE, -Integer.MAX_VALUE), "2000.01.06 0N 0W -0W", "2000.01.06 0N 0W -0W");
    }
    ...
    public void testMonthToString() throws Exception {
        ...
        check(new K.Month(-Integer.MAX_VALUE), "-0Wm", "-0Wm");
        check(new K.Month(Integer. MAX_VALUE), "0Wm", "0Wm");
        check(new K.Month(Integer.MIN_VALUE), "0Nm", "0Nm");
    ...
    public void testDatetimeToString() throws Exception {
        check(new K.KDatetime(-123456.789), "1661.12.26 05:03:50.401", "1661.12.26 05:03:50.401");
        check(new K.KDatetime(123.456), "2000.05.03 10:56:38.400", "2000.05.03 10:56:38.400");
        ...
        check(vector(K.KDatetimeVector.class, -10.0, 10.0, 3.0), "1999.12.22 00:00:00.000  2000.01.11 00:00:00.000  2000.01.04 00:00:00.000", "1999.12.22 00:00:00.000  2000.01.11 00:00:00.000  2000.01.04 00:00:00.000");
        check(vector(K.KDatetimeVector.class), "`datetime$()", "`datetime$()");
        check(vector(K.KDatetimeVector.class, 0.0), "enlist 2000.01.01 00:00:00.000", "enlist 2000.01.01 00:00:00.000");
        check(vector(K.KDatetimeVector.class, 5.0, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, Double.NaN), "2000.01.06 00:00:00.000  -0w  0w  0N", "2000.01.06 00:00:00.000  -0w  0w  0N");
    }
    ...
    public void testListToString() throws Exception {
        ...
        check(vector(K.KList.class, new K.KLong(10), new K.KLong(Long.MAX_VALUE)), "(10;0W)", "(10j;0Wj)");
        check(vector(K.KList.class, new K.KLong(10), new K.KInteger(10)), "(10;10)", "(10j;10i)");
        check(vector(K.KList.class, new K.KLong(10), new K.KInteger(10), vector(K.KList.class, new K.KDouble(1.1))), "(10;10;enlist 1.1)", "(10j;10i;enlist 1.1)");
    }
    ...
    public void testOtherToString() throws Exception {
        ...
        check(new K.Projection((K.KList)vector(K.KList.class, funcBinary, new K.KLong(1), new K.UnaryPrimitive(-1))), "{x+y}[1;]", "{x+y}[1j;]");
        check(new K.Projection((K.KList)vector(K.KList.class, funcBinary, new K.UnaryPrimitive(-1), new K.KLong(1))), "{x+y}[;1]", "{x+y}[;1j]");
        ...
        //wrong output
        //should it be 1+ ?
        check(new K.Projection((K.KList)vector(K.KList.class, new K.BinaryPrimitive(1), new K.KLong(1))), "+[1]", "+[1j]");
        //should it be '[;]
